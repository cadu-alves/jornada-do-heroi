...
let textao3 = `Diante de um grande desafio, é natural que surjam os medos, hesitações e muitos conflitos interiores. Por isso, em um primeiro momento, o personagem recusa o chamado que recebeu e tenta convencer a si mesmo de que não se importa com aquilo.\n
...
let textao4 = `Diante do impasse em que se encontra, o nosso herói precisa de um empurrãozinho. É chegada a hora de ele encontrar seu mentor, que dará a ele o que for necessário para que ele enfrente o desafio que foi proposto.\n
...
let textao5 = `Finalmente, chegou o momento em que o nosso herói está pronto para cruzar o limite entre o mundo que ele conhece e com o qual está acostumado e o mundo novo para o qual ele deve ir.\n
...
let textao6 = `Agora que o herói colocou o pé na estrada rumo ao seu objetivo maior, ele começa a se deparar com diversos desafios menores, contratempos e obstáculos que, gradativamente, vão testando suas habilidades e deixando-o mais preparado para as maiores provações que ainda estão por vir.\n
...
let textao7 = `Sabe o recuo do mar antes do Tsunami? É nesse ponto que chegou o nosso herói. Aqui, ele faz uma espécie de pausa, se recolhe em um esconderijo — interior ou não — e retorna aos seus questionamentos iniciais e ao enfrentamento dos medos que o impediam de iniciar sua jornada.\n
...
let textao8 = `A provação é uma espécie de morte pela qual o nosso herói precisa passar para cumprir o seu destino. Para isso, ele passará por um teste físico de extrema dificuldade, enfrentará um inimigo letal ou passará por um conflito interior mortal.\n
...
let textao9 = `Depois que o nosso herói já passou por diversos desafios, como derrotar o inimigo e sobreviver à morte, ele merece uma recompensa, você não acha?\n
...
let textao10 = `O caminho de volta para casa não oferece tantos perigos, mas sim um momento de reflexão, em que o nosso herói poderá ser exposto à necessidade de uma escolha entre a realização de um objetivo pessoal ou um bem coletivo maior.\n
